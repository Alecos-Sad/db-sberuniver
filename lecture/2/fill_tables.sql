...
INSERT INTO student16.tb_countries (name)
VALUES ('США'),
       ('Южная Корея'),
       ('Россия'),
       ('СССР');
...
VALUES ('Минари',
        ...
        6.9);
INSERT INTO student16.tb_films (name, year, genre_id, director_id, age_rating, rating)
VALUES ('Воспоминания об убийстве',
        2003,
